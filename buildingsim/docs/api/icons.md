...
SVG equipment icons embedded in the binary. Used by the browser to render
equipment and mobile entities on the map.
...
# http://localhost:9090/api/icons/alien.svg
```
...
### Special (Occupancy, Robots & Fallback)
| | | | | | | |
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| ![man](../../data/equipment/icons/man.svg) | ![woman](../../data/equipment/icons/woman.svg) | ![group](../../data/equipment/icons/group.svg) | ![robot](../../data/equipment/icons/robot.svg) | ![cleaning_robot](../../data/equipment/icons/cleaning_robot.svg) | ![alien](../../data/equipment/icons/alien.svg) | ![generic](../../data/equipment/icons/generic.svg) |
| `man` | `woman` | `group` | `robot` | `cleaning_robot` | `alien` | `generic` |
